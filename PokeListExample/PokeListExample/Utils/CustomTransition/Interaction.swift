...
extension Transition {
    ...
    final class Interaction: NSObject {
        ...
        private func finishTransition(initialVelocity velocity: CGFloat) {
            ...
            snapshot.layer.cornerRadius = PokemonListCell.CornerRadius.large
            ...
            let headerView = Transition.Animator.Header(frame: newRect, image: image, cornerRadius: PokemonListCell.CornerRadius.large)
...
extension Transition.Interaction: InteractableTransition {
    ...
    func startInteractiveTransition(_ transitionContext: UIViewControllerContextTransitioning) {
        ...
        fromView.view.layer.cornerRadius = PokemonListCell.CornerRadius.large
